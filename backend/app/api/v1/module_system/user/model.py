...
class UserModel(ModelMixin, TenantMixin, UserMixin):
    ...
    gitee_login: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="外部账号登录")
    github_login: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="外部账号登录")
